...
echo -e   "${RED}****************************************************************************"
echo -e "${WHITE}**                                                                        **"
echo -e "${WHITE}**                    Powered By Oracle Linux                             **"
echo -e "${WHITE}**                                                                        **"
echo -e   "${RED}****************************************************************************"
...
echo -e ""
echo -e "${WHITE} Welcome ${YELLOW}${USER} ${WHITE} to the Container OFSAA APP Server"
echo -e ""
...
echo -e "${RED}******************************************************************************"
 echo -e ""
 echo -e "${WHITE} Software Installed: "
 echo -e ""
 echo -e "${GREEN} OFSAA Version     : 8.0.4   BD Pack"
 echo -e ""
echo -e "${RED}******************************************************************************"
 echo -e ""
 echo -e "${WHITE} TNS_ADMIN  : $TNS_ADMIN"
 echo -e "${WHITE} ORACLE_HOME: $ORACLE_HOME"
 echo -e "${WHITE} JAVA_HOME  : $JAVA_HOME"
 echo -e ""
 echo -e "${BLUE}  SHELL      : $SHELL"
 echo -e "${GREEN} FIC_HOME   : $FIC_HOME"
 echo -e "${GREEN} DOWNLOAD   : $DOWNLOAD"
 echo -e "${GREEN} FTPSHARE  : $FTPSHARE"
 echo -e "" 
 echo -e "${RED}******************************************************************************"
