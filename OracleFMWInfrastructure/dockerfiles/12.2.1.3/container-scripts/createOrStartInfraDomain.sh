...
echo "Start the Admin and Managed Servers if using them! "
echo ""
echo ""
echo "====================================="
echo "Starting SSHD server port 22"
...
export APP_ROOT="${DOMAIN_HOME}/applications"
...
#make the application dir if needed for Deployment to occur in the domain.
# War / ear files copied here will then be deployed.
#
