...
#
# Since: August 2016
# Author: Andy Baker Based on Author: gerald.venzl@oracle.com  Hacks!!!! to work on docker 1.12 and cloud
...
cd $INSTALL_DIR       && \
# note install_file_1 changed to multiple files as of size of single file zip.
cat $INSTALL_FILES | tar -xzvf - && \
#
# Taken out RM on zip files and also in docker file for install_dir.
# rm  $INSTALL_FILES && \
...
# Temp location
rm -rf /tmp/* && \
# Database files directory this is from the zip unzipped for stages.
